...
public class AlignToTag {
    ...
    public static final Transform3d leftCameraToRobot = new Transform3d(-0.068, 0, 0, new Rotation3d(0, 0, 0)); //TODO prossibly swapped
    public static final Transform3d rightCameraToRobot = new Transform3d(-0.068, 0, 0, new Rotation3d(0, 0, 0));
